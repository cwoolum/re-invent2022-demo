      ...
      >
        ...
        >
          <MyIcon
            ...
            {...getOverrideProps(overrides, "MyIcon30663196")}
          ></MyIcon>
          <Heading
            overflow="hidden"
            grow="1"
            ...
            {...getOverrideProps(overrides, "Heading30663197")}
          ></Heading>
        </Flex>
        <Flex
          gap="10px"
        ...
        >
          <MyIcon
            ...
            padding="0px 0px 0px 0px"
            type="info"
            {...getOverrideProps(overrides, "MyIcon30663203")}
          ></MyIcon>
          <Heading
            overflow="hidden"
            grow="1"
            ...
            {...getOverrideProps(overrides, "Heading30663204")}
          ></Heading>
        </Flex>
        <Text
          fontFamily="Inter"
